...
function flatsome_content_nav( $nav_id ) {
	...
	<div class="flex-row next-prev-nav bt bb">
		<div class="flex-col flex-grow nav-prev text-left">
			    <?php previous_post_link( '<div class="nav-previous">%link</div>','' .get_flatsome_icon('icon-angle-left') . _x( '', 'Previous post link', 'flatsome' ) ); ?>

		</div>
		<div class="flex-col flex-grow nav-next text-right">
			    <?php next_post_link( '<div class="nav-next">%link</div>', get_flatsome_icon('icon-angle-right') . _x( '', 'Next post link', 'flatsome' ) ); ?>
		</div>
	</div>
